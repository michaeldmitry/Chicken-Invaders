...
int main(int, char const**)
{
    ...
    sf::Texture pic;
    if(!pic.loadFromFile(resourcePath() + "chicken sprite 3.png"))
        return EXIT_FAILURE;
    ...
    enemy.setEnemyTextureRect(sf::IntRect(0 * 80,0,80,97));
...
void changeChickenAnimation(Enemy& chicken, int& counter)
{
    chicken.setEnemyTextureRect(sf::IntRect(counter * 80,0,80,97));
}
